...
$pageMask[$table] = $mask;
$tables[$table] = array("fornecedores", " " . "Fornecedores");
$table = "Categorias";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("categorias", " " . "Categorias");
$table = "Materiais";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("materiais", " " . "Materiais");
...
$pageMask[$table] = $mask;
$tables[$table] = array("ponto_de_entrada", " " . "Ponto de Entrada");
$table = "Armazenagem";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("armazenagem", " " . "Armazenagem");
$table = "Projeto de Desenvolvimento de Sistemas_Usuarios";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
if( pageEnabled($table, 'edit') || pageEnabled($table, 'inline_edit') )
...
$pageMask[$table] = $mask;
$tables[$table] = array("projeto_de_desenvolvimento_de_sistemas_usuarios", " " . "Projeto de Desenvolvimento de Sistemas_Usuarios");
