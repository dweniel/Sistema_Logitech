...
class DB
{
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "ProjetodeDesenvolvimentodeSist" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "Armazenagem", "varname" => "ProjetodeDesenvolvimentodeSist__Armazenagem", "altvarname" => "Armazenagem", "connId" => "ProjetodeDesenvolvimentodeSist", "schema" => "", "connName" => "Projeto de Desenvolvimento de ");
			$dalTables[$conn->connId][] = array("name" => "Categorias", "varname" => "ProjetodeDesenvolvimentodeSist__Categorias", "altvarname" => "Categorias", "connId" => "ProjetodeDesenvolvimentodeSist", "schema" => "", "connName" => "Projeto de Desenvolvimento de ");
			$dalTables[$conn->connId][] = array("name" => "Fornecedores", "varname" => "ProjetodeDesenvolvimentodeSist__Fornecedores", "altvarname" => "Fornecedores", "connId" => "ProjetodeDesenvolvimentodeSist", "schema" => "", "connName" => "Projeto de Desenvolvimento de ");
			$dalTables[$conn->connId][] = array("name" => "Materiais", "varname" => "ProjetodeDesenvolvimentodeSist__Materiais", "altvarname" => "Materiais", "connId" => "ProjetodeDesenvolvimentodeSist", "schema" => "", "connName" => "Projeto de Desenvolvimento de ");
			$dalTables[$conn->connId][] = array("name" => "Ponto de Entrada", "varname" => "ProjetodeDesenvolvimentodeSist__Ponto_de_Entrada", "altvarname" => "Ponto_de_Entrada", "connId" => "ProjetodeDesenvolvimentodeSist", "schema" => "", "connName" => "Projeto de Desenvolvimento de ");
			$dalTables[$conn->connId][] = array("name" => "Projeto de Desenvolvimento de Sistemas_Usuarios", "varname" => "ProjetodeDesenvolvimentodeSist__Projeto_de_Desenvolvimento_de_Sistemas_Usuarios", "altvarname" => "Projeto_de_Desenvolvimento_de_Sistemas_Usuarios", "connId" => "ProjetodeDesenvolvimentodeSist", "schema" => "", "connName" => "Projeto de Desenvolvimento de ");
			$dalTables[$conn->connId][] = array("name" => "Projeto de Desenvolvimento de Sistemasuggroups", "varname" => "ProjetodeDesenvolvimentodeSist__Projeto_de_Desenvolvimento_de_Sistemasuggroups", "altvarname" => "Projeto_de_Desenvolvimento_de_Sistemasuggroups", "connId" => "ProjetodeDesenvolvimentodeSist", "schema" => "", "connName" => "Projeto de Desenvolvimento de ");
			$dalTables[$conn->connId][] = array("name" => "Projeto de Desenvolvimento de Sistemasugmembers", "varname" => "ProjetodeDesenvolvimentodeSist__Projeto_de_Desenvolvimento_de_Sistemasugmembers", "altvarname" => "Projeto_de_Desenvolvimento_de_Sistemasugmembers", "connId" => "ProjetodeDesenvolvimentodeSist", "schema" => "", "connName" => "Projeto de Desenvolvimento de ");
			$dalTables[$conn->connId][] = array("name" => "Projeto de Desenvolvimento de Sistemasugrights", "varname" => "ProjetodeDesenvolvimentodeSist__Projeto_de_Desenvolvimento_de_Sistemasugrights", "altvarname" => "Projeto_de_Desenvolvimento_de_Sistemasugrights", "connId" => "ProjetodeDesenvolvimentodeSist", "schema" => "", "connName" => "Projeto de Desenvolvimento de ");
		}
	}
