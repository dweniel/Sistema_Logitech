...
class ProjectSettings
{
	...
	*/
	...
	function getConnId()
	{
		...
		if( $connId == "" ) {
			return "ProjetodeDesenvolvimentodeSist";
		}
		return $connId;
	}
...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("Projeto de Desenvolvimento de Sistemas_Usuarios", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "Fornecedores" ] = array( "url" => "fornecedores", "type" => 0 );
	$projectEntitiesReverse[ "fornecedores" ] = "Fornecedores";
	$projectEntities[ "Categorias" ] = array( "url" => "categorias", "type" => 0 );
	$projectEntitiesReverse[ "categorias" ] = "Categorias";
	$projectEntities[ "Materiais" ] = array( "url" => "materiais", "type" => 0 );
	$projectEntitiesReverse[ "materiais" ] = "Materiais";
	$projectEntities[ "Ponto de Entrada" ] = array( "url" => "ponto_de_entrada", "type" => 0 );
	$projectEntitiesReverse[ "ponto_de_entrada" ] = "Ponto de Entrada";
	$projectEntities[ "Armazenagem" ] = array( "url" => "armazenagem", "type" => 0 );
	$projectEntitiesReverse[ "armazenagem" ] = "Armazenagem";
	$projectEntities[ "Projeto de Desenvolvimento de Sistemas_Usuarios" ] = array( "url" => "projeto_de_desenvolvimento_de_sistemas_usuarios", "type" => 0 );
	$projectEntitiesReverse[ "projeto_de_desenvolvimento_de_sistemas_usuarios" ] = "Projeto de Desenvolvimento de Sistemas_Usuarios";
