...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 6;
		$data["connId"] = "ProjetodeDesenvolvimentodeSist";
		$data["connName"] = "Projeto de Desenvolvimento de ";
		$data["connStringType"] = "sqlite";
		$data["connectionString"] = "sqlite;C:\\\\Projects\\\\Projeto de Desenvolvimento de Sistemas\\\\Projeto de Desenvolvimento de Sistemas.sqlite3"; //currently unused

		$this->_connectionsIdByName["Projeto de Desenvolvimento de "] = "ProjetodeDesenvolvimentodeSist";
		...
		$data["connInfo"][0] = "C:\\Projects\\Projeto de Desenvolvimento de Sistemas\\Projeto de Desenvolvimento de Sistemas.sqlite3";
		$data["connInfo"][1] = "";
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "";
		...
		$data["ODBCString"] = "DRIVER={SQLite3 ODBC Driver};Database=C:\\Projects\\Projeto de Desenvolvimento de Sistemas\\Projeto de Desenvolvimento de Sistemas.sqlite3";
		// encription set
		...
		$connectionsData["ProjetodeDesenvolvimentodeSist"] = $data;
