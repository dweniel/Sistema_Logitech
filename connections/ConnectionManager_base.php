...
class ConnectionManager_Base
{
	...
	{
		return $this->byId( "ProjetodeDesenvolvimentodeSist" );
	}
	...
	{
		$connectionsIds = array();
		$connectionsIds["Fornecedores"] = "ProjetodeDesenvolvimentodeSist";
		$connectionsIds["Categorias"] = "ProjetodeDesenvolvimentodeSist";
		$connectionsIds["Materiais"] = "ProjetodeDesenvolvimentodeSist";
		$connectionsIds["Ponto de Entrada"] = "ProjetodeDesenvolvimentodeSist";
		$connectionsIds["Armazenagem"] = "ProjetodeDesenvolvimentodeSist";
		$connectionsIds["Projeto de Desenvolvimento de Sistemas_Usuarios"] = "ProjetodeDesenvolvimentodeSist";
		$connectionsIds["admin_rights"] = "ProjetodeDesenvolvimentodeSist";
