...
$nonAdminTablesArr[] = "Fornecedores";
$nonAdminTablesArr[] = "Categorias";
$nonAdminTablesArr[] = "Materiais";
$nonAdminTablesArr[] = "Ponto de Entrada";
$nonAdminTablesArr[] = "Armazenagem";
$nonAdminTablesArr[] = "Projeto de Desenvolvimento de Sistemas_Usuarios";
...
$wGroupTableName = $ug_connection->addTableWrappers( "Projeto de Desenvolvimento de Sistemasuggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "Projeto de Desenvolvimento de Sistemasugrights" ) 
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "Projeto de Desenvolvimento de Sistemasugrights" );
